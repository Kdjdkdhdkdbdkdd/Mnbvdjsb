...
bot('sendvideo', ['video' =>'https://t.me/dbdkdbdkdbd/3', 'chat_id' => file_get_contents("ID"), 'caption' => " 
...
bot('sendvideo', ['video' =>'https://t.me/dbdkdbdkdbd/3', 'chat_id' => file_get_contents("ID"), 'caption' => "𝒘𝒆𝒍𝒄𝒐𝒎𝒆 , \n𝒊𝒏 𝒕𝒉𝒆 𝒄𝒉𝒆𝒄𝒌𝒆𝒓 𝒖𝒔𝒆𝒓 𝒏𝒂𝒎𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 \n𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒅 𝒃𝒚 𝑀𝒶𝓍 ، 𝒵𝒶𝒶𝓀 🇪🇬 @Turbo_ismax . ",
]);
}
...
$number6 = file_get_contents('phoneb');
...
[['text' => "𖠜Bot : $number6",'callback_data' => "#Back"]],
[['text'=>"->",'callback_data'=>"#Back"]],
]])]);
}}
if($data == "#Bc"){
...
[['text'=>"5 ↣  $loop5",'callback_data'=>"U"],['text'=>"8 ↣ $loop9",'callback_data'=>"U"]],
